...
def render_full(data: dict, output_name: str = "bl_today") -> str:
    ...
    # Set column widths: #=52, Club=292, W=D=L=GF=GA=PTS=32
    col_widths = [0] * 8
    col_widths[0] = 52   # #
    col_widths[1] = 292  # Club
    col_widths[2] = col_widths[3] = col_widths[4] = col_widths[5] = col_widths[6] = col_widths[7] = 32  # W,D,L,GF,GA,PTS
    ...
    for idx, row in enumerate(table):
        ...
        # Club name
        bbox = td.textbbox((0, 0), row.get("club_name", ""), font=font_tc)
        th = bbox[3] - bbox[1]
        td.text((col_x[1] + 4, ry + (row_h - th) // 2), row.get("club_name", ""),
                fill=(0, 0, 0, 255), font=font_tc)
    ...
    for mi, m in enumerate(matchday_results[:9]):
        ...
        draw.text((col1_x + 4, ty_mr), home[:12], fill=(0, 0, 0, 255), font=mf_cell)
        draw.text((col2_x + 4, ty_mr), score_str, fill=(200, 0, 0, 255), font=mf_score)
        draw.text((col3_x + 4, ty_mr), away[:12], fill=(0, 0, 0, 255), font=mf_cell)
...
def main():
    data = {
        ...
        "matchday": 33,
        "table": [
            {"position": 1, "zone": "zone-cl", "club_name": "Bayern Munich", "mp": 33, "w": 27, "d": 3, "l": 3, "gf": 95, "ga": 21, "pts": 84},
            {"position": 2, "zone": "zone-cl", "club_name": "Borussia Dortmund", "mp": 33, "w": 21, "d": 5, "l": 7, "gf": 69, "ga": 36, "pts": 68},
            {"position": 3, "zone": "zone-cl", "club_name": "Bayer Leverkusen", "mp": 33, "w": 19, "d": 7, "l": 7, "gf": 65, "ga": 33, "pts": 64},
            {"position": 4, "zone": "zone-cl", "club_name": "Eintracht Frankfurt", "mp": 33, "w": 17, "d": 8, "l": 8, "gf": 56, "ga": 40, "pts": 59},
            {"position": 5, "zone": "zone-el", "club_name": "RB Leipzig", "mp": 33, "w": 16, "d": 7, "l": 10, "gf": 52, "ga": 42, "pts": 55},
            {"position": 6, "zone": "zone-el", "club_name": "VfB Stuttgart", "mp": 33, "w": 15, "d": 8, "l": 10, "gf": 55, "ga": 46, "pts": 53},
            {"position": 7, "zone": "zone-7", "club_name": "SC Freiburg", "mp": 33, "w": 14, "d": 8, "l": 11, "gf": 47, "ga": 43, "pts": 50},
            {"position": 8, "zone": "zone-neutral", "club_name": "TSG Hoffenheim", "mp": 33, "w": 13, "d": 9, "l": 11, "gf": 49, "ga": 48, "pts": 48},
            {"position": 9, "zone": "zone-neutral", "club_name": "Werder Bremen", "mp": 33, "w": 11, "d": 9, "l": 13, "gf": 45, "ga": 53, "pts": 42},
            {"position": 10, "zone": "zone-neutral", "club_name": "Union Berlin", "mp": 33, "w": 10, "d": 10, "l": 13, "gf": 39, "ga": 46, "pts": 40},
            {"position": 11, "zone": "zone-neutral", "club_name": "FC Augsburg", "mp": 33, "w": 10, "d": 8, "l": 15, "gf": 37, "ga": 50, "pts": 38},
            {"position": 12, "zone": "zone-neutral", "club_name": "VfL Wolfsburg", "mp": 33, "w": 9, "d": 9, "l": 15, "gf": 42, "ga": 56, "pts": 36},
            {"position": 13, "zone": "zone-neutral", "club_name": "B. Mönchengladbach", "mp": 33, "w": 8, "d": 10, "l": 15, "gf": 41, "ga": 58, "pts": 34},
            {"position": 14, "zone": "zone-neutral", "club_name": "Mainz 05", "mp": 33, "w": 8, "d": 8, "l": 17, "gf": 35, "ga": 53, "pts": 32},
            {"position": 15, "zone": "zone-neutral", "club_name": "1. FC Köln", "mp": 33, "w": 6, "d": 10, "l": 17, "gf": 29, "ga": 60, "pts": 28},
            {"position": 16, "zone": "zone-relegation", "club_name": "VfL Bochum", "mp": 33, "w": 6, "d": 6, "l": 21, "gf": 27, "ga": 66, "pts": 24},
            {"position": 17, "zone": "zone-relegation", "club_name": "1. FC Heidenheim", "mp": 33, "w": 4, "d": 8, "l": 21, "gf": 25, "ga": 63, "pts": 20},
            {"position": 18, "zone": "zone-relegation", "club_name": "SV Darmstadt 98", "mp": 33, "w": 3, "d": 7, "l": 23, "gf": 22, "ga": 70, "pts": 16},
        ],
        "matchday_results": [
            {"home": "Dortmund", "score_h": 2, "score_a": 1, "away": "Frankfurt"},
            {"home": "Stuttgart", "score_h": 2, "score_a": 0, "away": "Leverkusen"},
            {"home": "Hoffenheim", "score_h": 1, "score_a": 1, "away": "Bremen"},
            {"home": "Augsburg", "score_h": 2, "score_a": 1, "away": "M'gladbach"},
            {"home": "RB Leipzig", "score_h": 3, "score_a": 1, "away": "St. Pauli"},
            {"home": "Wolfsburg", "score_h": 0, "score_a": 2, "away": "Bayern"},
            {"home": "HSV", "score_h": 2, "score_a": 1, "away": "Freiburg"},
            {"home": "1. FC Köln", "score_h": 1, "score_a": 2, "away": "Heidenheim"},
            {"home": "Mainz", "score_h": 0, "score_a": 2, "away": "Union Berlin"},
        ],
        "top_scorers": [
            {"name": "Harry Kane", "club": "Bayern", "goals": 35, "assists": 12},
            {"name": "Deniz Undav", "club": "Stuttgart", "goals": 18, "assists": 5},
            {"name": "S. Guirassy", "club": "Dortmund", "goals": 16, "assists": 4},
            {"name": "Patrik Schick", "club": "Leverkusen", "goals": 15, "assists": 6},
            {"name": "Michael Olise", "club": "Bayern", "goals": 14, "assists": 14},
            {"name": "Florian Wirtz", "club": "Leverkusen", "goals": 13, "assists": 11},
            {"name": "Jamal Musiala", "club": "Bayern", "goals": 12, "assists": 8},
            {"name": "Victor Boniface", "club": "Leverkusen", "goals": 11, "assists": 3},
            {"name": "Leroy Sané", "club": "Bayern", "goals": 10, "assists": 9},
            {"name": "Xavi Simons", "club": "Leipzig", "goals": 9, "assists": 7},
        ],
    }
